 ...
 */
@RestController
@RequestMapping("/api/shipments/ci/amounts")
public class CommercialInvoiceAmountResource extends BaseResource {

    private CommercialInvoiceAmountService commercialInvoiceAmountService;

    @Autowired
    public CommercialInvoiceAmountResource(CommercialInvoiceAmountService commercialInvoiceAmountService) {
