...
public final class CertificateOfOriginUploadDataRowMapper extends UploadDataRowMapper {

    @SuppressWarnings("SqlDialectInspection")
    @Override
    public final UploadData mapRow(ResultSet rs, int rowNum) throws SQLException {
        final CertificateOfOriginUploadData data = new CertificateOfOriginUploadData();
