...
public final class Feature extends BaseModel<Integer> {
    ...
    public enum Type {
        APP_HOME, SMTP_SERVER, SMTP_USERNAME, SMTP_PWD, SMTP_DEBUG, SMTP_PORT, NON_PRODUCTION_EMAIL
        , OUTGOING_DISPLAY_NAME, OUTGOING_EMAIL, APPLICATION_ROOT_URL, CAMUNDA_ADMIN_URL, GATEWAY_URL
    }
