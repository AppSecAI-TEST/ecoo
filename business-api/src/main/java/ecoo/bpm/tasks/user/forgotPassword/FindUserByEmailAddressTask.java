...
@Component
public class FindUserByEmailAddressTask implements JavaDelegate {

    private final Logger log = LoggerFactory.getLogger(FindUserByEmailAddressTask.class);

    private UserService userService;

    @Autowired
    public FindUserByEmailAddressTask(UserService userService) {
    ...
    public void execute(final DelegateExecution delegateExecution) throws Exception {
        ...
        final User targetUser = userService.findByPrimaryEmailAddress(request.getEmailAddress());
