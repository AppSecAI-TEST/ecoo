...
@Component
public class SendShipmentNeedsMoreWorkNotificationTask implements JavaDelegate {

    private final Logger log = LoggerFactory.getLogger(SendShipmentNeedsMoreWorkNotificationTask.class);

    private NotificationService notificationService;

    @Autowired
    public SendShipmentNeedsMoreWorkNotificationTask(NotificationService notificationService) {
    ...
    public void execute(final DelegateExecution delegateExecution) throws Exception {
        ...
        final MimeMessage message = notificationService.createShipmentNotification(shipment, "Needs More Work");
